...
Microtype is a flexible portfolio theme with plenty of options. It is optimized for all devices. You can choose between light and dark theme, widget sidebar to the left or right - or no sidebar at all. You can also enable a light/dark theme toggle switch in the sidebar. Demo: http://demo.alx.media/x/?theme=Microtype

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in Microtype in the search form and press the 'Enter' key on your keyboard.
...
Microtype WordPress Theme, Copyright 2021 AlxMedia
Microtype is distributed under the terms of the GNU GPL
...
Microtype bundles the following third-party resources:
...
2. https://stocksnap.io/photo/IPXQTD44G8 - CC0 1.0 Universal (CC0 1.0)
